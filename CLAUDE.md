...
| 特許取得済み | **特許出願中**（正式に出願されたため、出願中で開示できる範囲は出してよい） |
| 武蔵野美術大学研究紀要 / 研究紀要掲載予定 / 論文 Exp.X / §X-X | **2027年3月まで論文には触れない**。**大学関連の表現もサイトから撤去**（badge・E-E-A-T含め）。E-E-A-T は Jag Yamamoto／ジャグプロジェクト合同会社／[jagproject.com](https://www.jagproject.com/) で担保 |
| 山本釈弘（研究時名義） | **Jag Yamamoto ／ 山本雅弘** に統一（研究時のペンネームは 2027-03 まで非公開） |
...
- [ ] 料金は下限のみ
- [ ] 特許表現は「**特許出願中**」のみ（旧「特許出願関連技術」表記は撤去済み）
- [ ] 「武蔵野美術大学研究紀要」「論文」「Exp.X」表記が残っていない（2027-03まで禁止）
- [ ] 論文ペンネーム「山本釈弘」表記が残っていない（Jag Yamamoto に統一）
