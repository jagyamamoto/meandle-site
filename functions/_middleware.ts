...
<style>
  ...
  * { box-sizing: border-box; }
  body { font-family: 'Noto Sans JP', -apple-system, BlinkMacSystemFont, 'Hiragino Sans', sans-serif; background: linear-gradient(180deg,#071014 0%,#12242C 100%); color: #F3F0E7; margin: 0; min-height: 100vh; display: grid; place-items: center; padding: 20px; font-feature-settings: "palt"; -webkit-font-smoothing: antialiased; }
  .card { background: #FFF9ED; color: #12242C; padding: 44px 36px 32px; border-radius: 20px; max-width: 400px; width: 100%; border: 1px solid rgba(18,36,44,0.08); box-shadow: 0 20px 60px rgba(0,0,0,0.4); }
